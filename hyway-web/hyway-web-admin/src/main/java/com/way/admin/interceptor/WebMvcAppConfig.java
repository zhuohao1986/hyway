 ...
 * 
 * @Configuration public class WebMvcAppConfig {
 * 
 *//**
	 * 
	 ...
	 *//*
		 ...
		 * 
		 * @Bean //把我们的拦截器注入为bean public HandlerInterceptor getLoginInterceptor(){
		 * return new LoginInterceptor(); }
		 * 
		 * @Override public void addInterceptors(InterceptorRegistry registry) { //
		 * addPathPatterns 用于添加拦截规则, 这里假设拦截 /url 后面的全部链接 // excludePathPatterns 用户排除拦截
