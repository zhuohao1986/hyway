...
public class CodeConstants {
	...
	/********************** 返回码 ****************************/
	/** 成功 **/
	public final static String RESULT_SUCCESS = "GL_S000";
	/** 失败 **/
	public final static String RESULT_FAIL = "GL_F000";
	// 请求渠道
	public final static String ALL_REQUEST_CHANNEL_ANDORID = "andorid";// andorid
